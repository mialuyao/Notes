...
def loadDataSet(regression):
	...
	"""
	numFeat = len(open(
	    '/Users/wangluyao/Documents/for_github/coding/regression/data.txt').readline().split('\t')) - 1
	xArr = []; yArr = []
	fr = open('/Users/wangluyao/Documents/for_github/coding/regression/data.txt')
...
def plotlwlrRegression():
	...
	Modify:
		2017-11-15
	"""
	# font = FontProperties(fname=r"/System/Library/Fonts/Times.ttc", size=14)
	xArr, yArr = loadDataSet('data.txt')  # 加载数据集
